# ==============================================================================
#  CHURN PREDICTIVE MODELING - CUSTOM BUILD
# ==============================================================================
#
# This script builds predictive models specifically for your  subscription data
# Using the actual schema with 44 columns
#
# ==============================================================================
...
# Select features for modeling based on YOUR actual data
...
# Save model
saveRDS(rf_model, "ML_rf_churn_model.rds")
cat("✓ Model saved: ML_rf_churn_model.rds\n")

# Save predictions
write.csv(predictions_df, "ML_churn_predictions.csv", row.names = FALSE)
cat("✓ Predictions saved: ML_churn_predictions.csv\n")

# Save feature importance
write.csv(rf_importance_df, "ML_feature_importance.csv", row.names = FALSE)
cat("✓ Feature importance saved: ML_feature_importance.csv\n")

# Save model comparison
write.csv(model_comparison, "ML_model_comparison.csv", row.names = FALSE)
cat("✓ Model comparison saved: ML_model_comparison.csv\n\n")
...
cat("╔════════════════════════════════════════════════════════════╗\n")
cat("║           ACTIONABLE RECOMMENDATIONS - ML                 ║\n")
cat("╚════════════════════════════════════════════════════════════╝\n\n")
